...
public class BoundAspectRatioTests {
  ...
  public void equalize_alreadyEqualized_LeftBoundSame() {
    AspectRatioEqualizer boundAspectRatio = new AspectRatioEqualizer(new Bound(0, 0, 0, 0));
    assertEquals(0.0, boundAspectRatio.equalize().getLeft(), 0.001);
  }

  @Test
  public void equalize_WiderThanTall_TopAdjusted() {
    AspectRatioEqualizer boundAspectRatio = new AspectRatioEqualizer(new Bound(5, 10, -5, -10));
    assertEquals(10.0, boundAspectRatio.equalize().getTop(), 0.001);
  }

  @Test
  public void equalize_MoreWiderThanTall_TopAdjusted() {
    AspectRatioEqualizer boundAspectRatio = new AspectRatioEqualizer(new Bound(5, 15, -5, -15));
  ...
  public void equalize_WiderThanTallButOffsetFromOrigin_TopAdjusted() {
    AspectRatioEqualizer boundAspectRatio = new AspectRatioEqualizer(new Bound(5, 20, -5, 0));
    assertEquals(10.0, boundAspectRatio.equalize().getTop(), 0.001);
  }
  ...
  public void equalize_WiderThanTall_LeftNotTouched() {
    AspectRatioEqualizer boundAspectRatio = new AspectRatioEqualizer(new Bound(5, 20, -5, 5));
  ...
  public void equalize_TallerThanWide_LeftAdjusted() {
    AspectRatioEqualizer boundAspectRatio = new AspectRatioEqualizer(new Bound(10, 5, -10, -5));
